...
module Phlexi
  class DisplayTest < Minitest::Test
    ...
    def test_form_renders_with_string
      render Phlexi::Display("object") { render field(:name).input_tag }
    ...
    def test_form_renders_all_field_types
      html_string = Phlexi::Display(@user) do
    ...
    class CustomFieldBuilder < Phlexi::Display::Base::FieldBuilder
      def custom_tag(...)
        label_tag(...)
      end
    end

    class CustomDisplayBase < Phlexi::Display::Base
    ...
    def test_that_it_uses_explicit_custom_field_builder
      render CustomDisplay.new(:custom_form) {
    ...
    def test_submit_button
      ...
      if gem_present?("rails")
        assert_equal "Save Display", submit_btn.text
      else
        assert_equal "Submit Display", submit_btn.text
      end
    end
